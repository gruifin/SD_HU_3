 ...
 *
 * xp: horizontal position of the pixel
 * yp: vertical position of the pixel
 ...
 *
 * micros: amount of time in microseconds
 *
 * returns: no returns
 *
 */
 ...
 * Delays the code for a certain amount of time
 *
 * millis: amount of time in miliseconds
 *
 * returns: no returns
 *
 */
...
/*
 * Function:	API_IO_UART_putchar
 * ----------------------------------
 * UART writes a char
 *
 * c: the char that has to be put
 *
 */
...
/*
 * Function:	API_IO_UART_puts
 * ----------------------------------
 * UART writes a string
 *
 * s: the string that has to be put
 *
 */
...
/*
 * Function:	API_IO_UART_putint
 * ----------------------------------
 * UART writes an unsigned integer
 *
 * num: the integer that has to be put
 *
 */
...
/*
 * Function:	API_IO_UART_putnum
 * ----------------------------------
 * UART writes an unsigned in given number system
 *
 * num: the integer that has to be put
 * deel: the number system in which the integer has to put
 *
 */
...
/*
 * Function:	API_IO_UART_get
 * ----------------------------------
 * UART receives incoming char
 *
 */
...
/*
 * Function:	API_IO_UART_gets
 * ----------------------------------
 * UART receives incoming string
 *
 * s: string that is received
 * echo: when True, send read-char to UART
 *
 */
