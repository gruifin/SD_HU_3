		 						...
		 						if (string[j] == ',')
		 		 		 				{
		 		 		 					...
		 		 		 					switch (comma) {
		 		 		 						...
		 		 		 						case 3:
		 		 		 							...
		 		 		 							break;
		 		 		 						case 4:
		 		 		 							strcpy(txt.text, txt.buff);
		 		 		 							break;
		 		 		 						case 5:
				 				 					strcpy(color,txt.buff);
				 				 					txt.colint = API_Draw_Color_To_Int(color);
		 		 		 							break;
		 		 		 						case 6:
		 		 		 							strcpy(txt.font, txt.buff);
		 		 		 						default:
		 		 		 							break;
		 		 		 					...
		 		 		 					counter = 0;
		 		 		 					memset(txt.buff,0,200);
		 		 		 				}
		 		 		 				else if (string[j] == 0 && comma == 7) {
		 		 		 					strcpy(txt.style, txt.buff);
		 		 		 					API_Draw_Font(txt);
		 		 			 				memset(txt.buff,0,TYPE_LENGTH);
		 		 			 				memset(color,0,COLOR_LENGTH);
		 		 		 					break;
		 		 		 				}

		 		 		 				else if(comma >= 1){
		 		 		 				txt.buff[counter] = string[j];
		 		 		 				counter++;
		 		 		 				}
